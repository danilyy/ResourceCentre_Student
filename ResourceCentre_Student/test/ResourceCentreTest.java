...
public class ResourceCentreTest {
	...
	public void testDoLoanCamcorder() {
		...
		assertFalse("Test if the same loaned item is not ok for loan again?", isLoan);
		
		ResourceCentre.addCamcorder(camcorderList, cc2);
		cc2.setIsAvailable(false);
		isLoan = ResourceCentre.doLoanCamcorder(camcorderList, "CC0012", "8-8-2020");
		assertFalse("Test if a loaned item is not ok for loan again?", isLoan);
		
		isLoan = ResourceCentre.doLoanCamcorder(camcorderList, "CC0013", "8-8-2020");
		assertFalse("Test if a non-existing item is not ok for loan?", isLoan);
